...
impl MapEvent {
    pub fn zoom_by_scroll(map: &mut MapInstance, scroll_delta_y: f32) {
    ...
    pub fn pan_by_pixels(map: &mut MapInstance, delta_x: f32, delta_y: f32) {
    ...
    pub fn coordinate_text(map: &MapInstance) -> String {
