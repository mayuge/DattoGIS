                ...
                div()
                        ...
                        div()
                            ...
                            .child(
                                div()
                                    .flex_col()
                                    .child("Auto Width")
                                    .child(img("https://tile.openstreetmap.org/14/14551/6459.png").h(px(180.))),
                            )
                            .child(
                                div()
                                    .flex_col()
                    ...
                    .child(
                        div()
                            ...
                            .child(img("https://tile.openstreetmap.org/14/14551/6459.png").max_w_full()),
                    ),
            )
    }
}
    ...
    .run(move |cx: &mut App| {
        ...
        cx.open_window(window_options, |_, cx| {
            cx.new(|_| ImageShowcase {
                local_resource: manifest_dir.join("src/app-icon.png").into(),
